# camera-surveillance-stack-demo
...
- simple dashboard UI
- 2 fake camera panels using local animated SVG feeds
- random motion/activity indicators
- mock event list with playful cat-detection events
- no backend required
